...
public class WxMpEndpointServlet extends HttpServlet {
	...
	public WxMpEndpointServlet(WxMpConfigStorage wxMpConfigStorage,
			WxMpService wxMpService, WxMpMessageRouter wxMpMessageRouter) {
	...
	protected void service(HttpServletRequest request,
		...
		response.getWriter().println("不可识别的加密类?");
		return;
	}
